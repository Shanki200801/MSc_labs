/*-----------------------------------------------------------
Program to implement linear search with a
multi linear search overload
@Author - Shashank
-------------------------------------------------------------*/
package Final_codes;
...
public class LinSearchOverload {
    ...
    public static void linearSearch(int element, int[] array, boolean multiple) {
        if (multiple) {
            ...
            // calling the other overload if multi-flag is off
    ...
    public static void main(String[] args) {
        ...
        linearSearch(element, array, true);
