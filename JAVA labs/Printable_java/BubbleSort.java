/*-----------------------------------------------------------
Program to implement bubble sort and use built in packages
@Author - Shashank
-------------------------------------------------------------*/
        ...
        for (int ind1 = 0; ind1 < arr.length - 1; ind1++) { // Sorting iteration
            ...
            for (int ind2 = 0; ind2 < arr.length - ind1 - 1; ind2++) {
                ...
                if (arr[ind2] > arr[ind2 + 1]) {
                    ...
                    arr[ind2 + 1] = temp;
                    swapChecker = true;
                    // Once swapChecker is true, next sorting iteration is
                    // performed or the sorted array is printed if all elements
                    // are sorted
            ...
            if (swapChecker != true) {
                ...
                // Sorting iteration will continue as long as swapChecker is false
